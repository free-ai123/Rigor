...
- **archive**: `/root/.hermes/profiles/orchestrator/migration/openclaw/20260513T204129/archive/workspace/IDENTITY.md` -- No direct Hermes destination; archived for manual review
- **archive**: `/root/.hermes/profiles/orchestrator/migration/openclaw/20260513T204129/archive/workspace/TOOLS.md` -- No direct Hermes destination; archived for manual review
- **archive**: `/root/.hermes/profiles/orchestrator/migration/openclaw/20260513T204129/archive/workspace/HEARTBEAT.md` -- No direct Hermes destination; archived for manual review
